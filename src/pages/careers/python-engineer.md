...
contract: 'Full Time'
position: 'Python Engineer (All levels)'
description: 'Join JUXT as a Python Engineer, building secure platforms for a global financial leader. Full-time, hybrid role, based in London.'
draft: false
weight: 1
googleJobs:
  {
...
The ideal candidate is a seasoned Python developer with hands-on experience in engineering transformative solutions using open-source tech, and deep experience in varied language stacks _(Python is the main requirement, but experience in other languages would be beneficial)_.
