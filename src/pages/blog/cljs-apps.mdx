...
typeahead library to supersede them all.
...
import user from '../../assets/blog/user.svg?url'

<img src={user} alt="" />

And you could test it like this:

import bbt from '../../assets/blog/blackbox-testing.svg?url'
...
import splitting from '../../assets/blog/splitting-ui.svg?url'

<img src={splitting} alt="" />
...
import uiSpec from '../../assets/blog/ui-spec.svg?url'
...
import modelTesting from '../../assets/blog/model-testing.svg?url'

<img src={modelTesting} alt="" />
...
import dCardsTesting from '../../assets/blog/devcards-testing.svg?url'

<img src={dCardsTesting} alt="" />
...
import modelView from '../../assets/blog/model-view-testing.svg?url'

<img src={modelView} alt="" />
...
import fStackTesting from '../../assets/blog/full-stack-testing.svg?url'

<img src={fStackTesting} alt="" />
