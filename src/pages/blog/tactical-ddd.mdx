...
description: "An introduction to Aggregates and Repositories"
...
The core concept is the *aggregate*.
An aggregate is an object made from *entities*, *value objects* and *business logic*.
...
> One entity is chosen as the *root* of the aggregate and all interactions with the aggregate entities and value objects must be made through it.
