...
The problem predates the name by decades. In his 1972 Turing Award lecture, [Edsger Dijkstra](https://en.wikipedia.org/wiki/Edsger_W._Dijkstra) [observed](https://www.cs.utexas.edu/~EWD/transcriptions/EWD03xx/EWD340.html) that "the competent programmer is fully aware of the strictly limited size of his own skull". The skull hasn't grown. The systems have.
