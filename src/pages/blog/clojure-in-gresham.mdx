...
<span class='pullquote' text-content='If you break functions up so that they just do one very small thing, you can run that directly in the REPL. Make sure you have ways to switch things on and off.'/>
