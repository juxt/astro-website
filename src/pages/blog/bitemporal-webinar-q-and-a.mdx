...
description: 'An edited transcript of questions and answers with our recent live webinar attendees.'
...
<figure>
  <Image alt='9999-12-31 is used in a table of data to represent infinity' width={1000} src={pi} class='mx-auto' />
  <figcaption>
...
<figure>
  <Image alt='A table of synonyms for SQL:2011 system time and application time' width={1000} src={tip} class='mx-auto' />
  <figcaption>
...
<figure>
  <Image alt='An example of a bitemporal table schema in SQL:2011' width={1000} src={hiuh} class='mx-auto' />
  <figcaption>
...
<figure>
  <Image alt='A snippet of XTDB SQL showcasing the ability to insert arbitrary data without' width={1000} src={se} class='mx-auto' />
  <figcaption>
...
<figure>
  <Image alt='A illustration of a system time timeline with data being appended, alongside an illustration of a valid time timeline where data can be inserted at any point' width={1000} src={ites} class='mx-auto' />
  <figcaption>
