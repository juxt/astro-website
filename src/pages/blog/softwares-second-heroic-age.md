...
<span class="pullquote" text-content="An LLM that holds every perspective can red-team any position you put in front of it."></span>
...
But in this current window, an engineer with good judgement and the right tools can produce work with both the coherence of a single vision and the verification that used to require a room full of specialists. AI has created the conditions for many more Brunels. It can also be the geologists Mulholland never consulted: the *obeya* for one.
