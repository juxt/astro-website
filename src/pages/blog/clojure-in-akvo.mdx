...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2016-09-27'
heroImage: 'akvo-logo.jpg'
clojureIn: { season: 'one', industry: 'mobile', quote: '"It takes the right people with the right motivation and the right tools to make a project succeed."' }
---
