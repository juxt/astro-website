...
Hugging Face hosts source code for free. You can see GPT 2 on there, (LLaMA from Facebook)[https://ai.meta.com/blog/large-language-model-llama-meta-ai/], (https://lmsys.org/blog/2023-03-30-vicuna/)[Vicuna].

**Jon: So you've recently swapped out some NLP modules for LLMs. What does the Clojure side look like, what's your go to Clojure tech stack?**
