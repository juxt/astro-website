...
**Jon: Wow, that's really successful! So what sort of architecture do you have? Lots of ETL, something like that?**
...
**Jon: Where do you make use of Clojure in the stack and what do you use for the AI?**

**Paul:**

The back-end is all in Clojure, the front-end is JavaScript, and the machine learning is in Python. Python for machine learning because of the ecosystem and the people in that community. It's the people that matters; the language is a tool.
