...
**Jon: Wow, that's really successful! So what sort of architecture do you have?**

**Paul:** I imagine it's a lot like the financial system you have. The biggest challenge for us is both transactional and business processes. Transactional processes such as making a withdrawals or in our case sending out an email being an atomic unit of action and business process being a series of those to formulate something that matters to the business. In the case of sending out an email it could be the creative aspects of asset to choose who to email and regulatory things like GDPR.
