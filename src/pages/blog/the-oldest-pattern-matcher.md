...
Pattern matching, analogy, recognition, intuition, metaphor: these are different names for the same cognitive operation. When a physicist reads a diagram, a mathematician feels a proof is right, or an LLM finds structure in text, the underlying act is the same: recognising that this situation resembles that one, and acting on the resemblance.
