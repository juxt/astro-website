...
Today, we'll explore a technique called "API flattening" using PolarMqtt, a toy C++ library I created specifically for this demonstration. While inspired by [Eclipse Paho](https://github.com/eclipse-paho/paho.mqtt.c), PolarMqtt exists purely to illustrate these concepts - for production MQTT needs, use the official [paho-mqtt](https://crates.io/crates/paho-mqtt) crate.
