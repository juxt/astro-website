...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2017-02-17'
heroImage: 'clojure-in-default.jpg'
clojureIn: { season: 'one', industry: 'e-commerce', quote: '"Clojure has helped us to focus on delivering business value."' }
---
