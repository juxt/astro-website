...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2016-11-18'
heroImage: 'skroutz-logo.jpg'
clojureIn: { season: 'one', industry: 'e-commerce', quote: '"We do not want a Clojure version of Rails!"' }
---
