...
We also add a `size` field so we can answer the question of the total size of the bag in $O(1)$.
...
* [https://www.brainonfire.net/files/seqs-and-colls/main.html](https://www.brainonfire.net/files/seqs-and-colls/main.html)
