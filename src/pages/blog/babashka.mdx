...
Our standard operating system is GNU/Linux ([Arch
Linux](https://www.archlinux.org/)), which we use on both developer
...
database. Naturally we use [GNU
Make](https://www.gnu.org/software/make/) and bash to knit together
...
`clj-kondo` fame. Babashka is [close
enough](https://github.com/borkdude/babashka#differences-with-clojure)
