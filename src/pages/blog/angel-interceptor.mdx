...
it somewhat easier but [comes with its own
pitfalls](http://davidjameshumphreys.github.io/patterns-pitfalls-liberator).
...
leaf handler. This leads to a wonderful realisation:

<Image width='300' src={handlersRealisation} />
...
recommend [an excellent talk by Frankie
Sardo](https://skillsmatter.com/skillscasts/6812-pedestal-new-wave) on
...
[Angel Interceptor is on
Github](https://github.com/oliyh/angel-interceptor), feedback and
