...
<Image alt='devart' src={de} />

import pr from '../../assets/blog/toxi-print.jpg'

<Image alt='print' src={pr} />
...
<iframe
  ...
  src="https://www.youtube.com/embed/gxwy9XNrXRc"
  title="XT16 - Computational Design"
  frameborder="0"
