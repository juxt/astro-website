...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2018-10-10'
heroImage: 'world-singles-network-logo.jpg'
clojureIn: { season: 'one', industry: 'startups & software', quote: '"Clojure is solid programming and engineering whilst still feeling fun."' }
---
