...
heroImage: 'xt26-simone-steel.jpg'
tags:
  - 'XT26'
  - 'Data'
  - 'conference'
...
The topic of mapping has been a passion of mine for quite some time (I was even fortunate enough to attend Simon Wardley’s inaugural [Map Camp 2017](https://www.map-camp.com/_pages/2017-10-05_London/)), so I was nodding in vigorous agreement for much of the talk. Even so, Simone introduced me to plenty of fresh perspectives, like the ‘[Reification Fallacy](https://en.wikipedia.org/wiki/Reification_(fallacy))’ that rather implies most organisations are far too reliant on systems that deal with lagging “snapshots of intent”, which are really just projections of what we think of as reality, and leave us all unable to explain what’s going on as things evolve in the real world.
