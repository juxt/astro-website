...
<Image src={alanTuring} />

# How Can we classify if a machine has artificial Intelligence?

In 1950, Alan Turing proposed the [Turing
Test](http://psych.utoronto.ca/users/reingold/courses/ai/turing.html),
...
The first machine to pass the Turing Test was a chatbot [Eugene
Goostman](https://en.wikipedia.org/wiki/Eugene_Goostman), created by
...
they will start to advance at an exponential rate (think [I
Robot](https://www.youtube.com/watch?v=rL6RRIOZyCM) or
...
are declaring that Alexa has the [First Amendment Right of Free
Speech](http://fortune.com/2017/02/23/amazon-free-speech-alexa-murder/).
