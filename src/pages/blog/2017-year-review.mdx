...
speed-up [release of
CIDER](https://github.com/clojure-emacs/cider/releases/tag/v0.16.0), not
...
organisations will always be conservative in language selection up until
