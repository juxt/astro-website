...
description: 'AI techniques that have proven their value in production environments and are recommended for immediate use'
category: 'ai'
...
<div data-radar='true' data-meta='{"label":"Classical ML"}' />
## Classical ML
...
<div data-radar='true' data-meta='{"label":"LLM-as-a-Judge"}' />
## LLM-as-a-Judge
...
<div data-radar='true' data-meta='{"label":"BERT Variants"}' />
## BERT Variants
...
<div data-radar='true' data-meta='{"label":"Few-shot Prompting"}' />
## Few-shot Prompting
