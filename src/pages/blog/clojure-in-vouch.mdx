...
[React Native](https://reactnative.dev/) has been instrumental. We've sweated many hours getting the UI and UX flow just right, using React Native, Krell, ClojureScript, and [Storybook](https://storybook.js.org/).
...
**Anthony:** Scenario based testing is something that [David's done a whole load of work on](https://www.youtube.com/watch?v=qDGTxyIrKJY), it's something that's a real passion for him, it's also something that others, even our newer members, have taken on and really built out across the product. 
...
I've been on the other side of it, trying to convince companies as an architect to use Clojure. It's hard and maybe it's your reputation that gets it over the line. There was a lack of resources to point people to, to help reassureadn re-enforce the value prop. 

**Jon: Why did you pick Clojure?**

**Anthony:** My history with Clojure goes way back to when I was working with Kristof Sajdak & Ray McDermott in Belgium and we were frustrated with Java at the time. We were both in architect roles and Java just didn't fit a lot of things that we were trying to do.
