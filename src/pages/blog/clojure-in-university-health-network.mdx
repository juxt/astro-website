...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2017-10-06'
heroImage: 'uhn-logo.jpg'
clojureIn: { season: 'one', industry: 'healthcare', quote: '"The small number of constructs put together becomes very powerful."' }
---
