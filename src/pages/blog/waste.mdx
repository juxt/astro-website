...
import cd1 from '../../assets/blog/cost-of-defects-1.svg?url'

<img src={cd1} alt='Graph showing the cost to fix defects rises exponentially over time.'
  width={500}
...
import cd2 from '../../assets/blog/cost-of-defects-2.svg?url'

<img src={cd2} alt='Graph showing the cost of waste, and hence opportunity for optimisation, reduces as we move from strategy to execution.'
  width={500}
