...
**Jon: Broadly, what's your tech stack?**
...
**Rahul:** We've historically used Python for infrastructure automation. Where we're dealing with a lot of unstructured data and especially query analysis for Elastic, we will use a mix of languages including Clojure. If you compare Golang and Clojure in terms of handling unstructured dynamic data, that's a big plus point for Clojure. We're using Babashka more and it's eating up our Python.
...
Joachim Draeger  - learnt Clojure in role alongside Python - we like to use Clojure as it's easy to paralyze and to operate.
...
Rahul Dé- Site Reliability Engineer (SRE) - Infrastructure - fun and unorthodox ways of using Clojure helps in tracing things - automating and providing decisions.
