...
**Charlie:** One concern worth mentioning is libraries being maintained by individuals, who may have moved on. A good example is Amazonica. We still mainly reach for Amazonica when interacting with services, but it is a concern that it's maintained by one person who doesn't work on Clojure anymore and it's built in SDK, which may get dropped by Amazon at some point.
