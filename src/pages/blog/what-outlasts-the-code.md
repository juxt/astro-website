...
Most organisations adopting AI are bolting the motor where the steam engine stood. They add copilots to existing workflows and agents to existing approval chains. As with the factories before them, many expect the real gains will come from redesigning rather than retrofitting, and [redesigning takes time](/blog/three-paradoxes).
...
**The engine shaped the building, the building shaped the thinking, and the thinking persisted longest of all.**
...
**AI makes code easier to change than ever, but code was never the hardest thing to change.**
