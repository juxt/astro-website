...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2017-03-16'
heroImage: 'sky-betting-gaming-logo.jpg'
clojureIn: { season: 'one', industry: 'media & telecommunications', quote: '"Ostensibly Clojure is a practical language."' }
---
