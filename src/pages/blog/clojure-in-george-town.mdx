...
Absolutely! We use [`test.check`](https://github.com/clojure/test.check) and specs to do generative testing.
...
Yes. This ties back to the convenience of having Clojure on the JVM because now we have access to all these great libraries.  [POI](https://poi.apache.org/) is fabulous because you have a stateless parser that you can use to parse open an Excel spreadsheet and to examine the functions and formulas.
