...
The processes we create are typically high performance and able to get answers quickly. They're stateless; so we want to make sure that given a particular input, we produce the same output every single time.  We'll run these processes in the cloud,
