...
defining its behaviour through the props, I thought this approach
...
<a href='https://clojars.org/fork'>
  src='https://clojars.org/fork/latest-version.svg' style='margin-bottom: 1em;'
  />
</a>
...
Additionally, we choose to prevent the submission default behaviour not
