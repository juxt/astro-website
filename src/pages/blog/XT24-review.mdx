...
Next, I sat down for a fireside discussion with [Kim Johannessen](https://www.linkedin.com/in/kjohannessen), a CTO and consultant who has spent decades working on the 'buy-side', including major hedgefunds. Kim gave us a tour of what the buy-side does, the main challenges, and what the landscape of the small and large players looks like. He reflected on the technologies typically used and where the future is headed. Kim has seen it all, and it was a pleasure to receive his overview.
