...
Humans haven't solved this either. Controlled experiments find [cognitive biases in architectural decision-making](https://www.researchgate.net/publication/317433924_On_Cognitive_Biases_in_Architecture_Decision_Making), from anchoring on familiar solutions to optimism about preferred approaches, and [practitioners are more susceptible than students](https://arxiv.org/html/2502.04011v1). Whether LLMs will prove better at navigating these trade-offs is genuinely open. But they make these choices on different grounds.
