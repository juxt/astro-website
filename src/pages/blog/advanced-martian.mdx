...
it is suggested you read that and/or [watch the ClojureX Bytes
talk](https://skillsmatter.com/skillscasts/8843-clojure-bytes#video) for
...
In the [re-frame library for
HTTP](https://github.com/Day8/re-frame-http-fx) you will see that
