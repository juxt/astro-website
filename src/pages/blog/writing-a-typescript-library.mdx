...
Notice that if you don't wanna start from scratch there is a github repo I setup, which you could download and use as a template.
...
Get typescript for a typed project:
...
Make sure that the main and module values match the name of your library.
