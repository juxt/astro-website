...
data in and returning data out. Also, it was very
...
_Miguel:_ Replicability and reproducibility are very
...
components to Clojure, but we realised that even though we love the
...
_Miguel_: We learned with [4Clojure](https://www.4clojure.com/) and we
