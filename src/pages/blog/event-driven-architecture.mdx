...
import eda-kafka from '../../assets/blog/eda-kafka.jpg'
...
## Message-Driven Architecture (light orange)
...
## Event Driven Architecture (light green)
...
## Domain Driven Design (light pink)
...
<Image alt='Kstreams location' src={eda-kafka} />
