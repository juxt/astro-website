...
Pragmatically, any system using events can be labeled an EDA.
...
In DDD, a catalog of software patterns helps the programmer and business in both building and working with complex domain models.
