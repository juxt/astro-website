...
A message-driven architecture (1) decouples systems in both time and location: producers of messages need not know when and where a consumer processes a message <sup>[[3]]</sup>.
...
DDD (A) is built around programming a Domain Model - wherein business logic and data are placed together in objects encapsulating the rules and processes of a (business) domain <sup>[[18]]</sup>.
