...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2017-01-13'
heroImage: 'red-pineapple-logo.jpg'
clojureIn: { season: 'one', industry: 'media & telecommunications', quote: '"Love that you can use the same language for both the front and the back end. This is the best decision this company has made."' }
---
