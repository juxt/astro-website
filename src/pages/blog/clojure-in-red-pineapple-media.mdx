...
clojureIn:
  {
    ...
    quote: '"Love that you can use the same language for both the front and the back end. This is the best decision this company has made."'
  }
---
...
developer Damiano Rühl and recent hire Joaquim Torres.
...
import spc from '../../assets/blog/spaceemacs.svg?url'

<img src={spc} width={200}  alt="" />
