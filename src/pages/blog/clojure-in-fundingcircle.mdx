...
clojureIn:
  {
    season: 'one',
    industry: 'finance',
    quote: '"Hiring good Clojure developers is not any harder than finding good Ruby developers."'
  }
---
...
We are trying to answer this question: can we have truly vertical
