...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2016-10-04'
heroImage: 'funding-circle-logo.jpg'
clojureIn: { season: 'one', industry: 'finance', quote: '"Hiring good Clojure developers is not any harder than finding good Ruby developers."' }
---
