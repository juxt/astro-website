...
Rather, a good API should be designed carefully to meet the needs of clients.
If the API provides too little, it might not meet the requirements of consumers.
