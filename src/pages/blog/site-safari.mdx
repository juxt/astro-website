...
[https://github.com/juxt-site/site](Site) is a project, which includes a number of libraries from JUXT and elsewhere, that allows us to develop APIs quickly and securely.
...
Finally, if you're embarking on a new system development and APIs are important to your project, do get in touch. We'd be very happy to advise and help.
