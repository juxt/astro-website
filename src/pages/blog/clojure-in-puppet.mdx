...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2016-11-11'
heroImage: 'puppet-logo.jpg'
clojureIn: { season: 'one', industry: 'startups & software', quote: '"With Clojure you naturally adhere to good design principles."' }
---
