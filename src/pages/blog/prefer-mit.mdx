...
import le from '../../assets/blog/license-epl-gpl-compat.svg?url'

<img src={le} alt="EPL & GPL compatibility chart" />
...
import lmc from '../../assets/blog/license-mit-compat.svg?url'

<img src={lmc} alt="MIT compatibility chart" />
