...
The spectroscope didn't replace the laboratory. Astronomers returned to it between experiments, each observation refining the questions the next experiment would test. But the spectroscope's first answers were not always welcome.
