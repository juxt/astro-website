...
author: 'mal'
title: 'URI Templates'
description: 'Unlocking the potential of URIs to embed state in hypertext applications'
category: 'clojure'
...
> <p>OpenAPI serialization rules are based on a subset of URI template patterns defined by RFC 6570.</p> ><footer>-- <cite>https://swagger.io/docs/specification/serialization/</cite></footer>
...
<Image style="width: 50%; margin-left: auto; margin-right: auto" alt='My talk at EuroClojure 2012. Check out the t-shirt' src={me} />
