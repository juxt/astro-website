---
author: 'mal'
title: 'URI Templates: Unlocking the potential of URIs to embed state in hypertext applications'
description: ''
category: 'clojure'
...
> <p>OpenAPI serialization rules are based on a subset of URI template patterns defined by RFC 6570.</p>
> <footer>-- <cite>https://swagger.io/docs/specification/serialization/</cite></footer>
...
It is particularly useful for string formats defined by Internet RFCs, including the URI Tempalte syntax.
...
Reap implements a parsing technique known as 'Parsing Expression Grammer', or PEG for short.
...
Reap comes with these are many more built-in 'pegs' (parsing expression grammers), and you can easily create your own.
