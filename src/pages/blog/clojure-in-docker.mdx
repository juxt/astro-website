...
<span class='pullquote right' text-content="Almost everything can go through queues, and therefore everything should go through queues. Once you're asynchronous, you may as well be that way throughout your platform."/>
...
<span class="pullquote left" text-content="We're all plumbers in the end. Integrating different systems. When you do that, you need a language like Clojure."/>
...
<span class="pullquote right" text-content="[W]orking without a REPL is just horrible. Ultimately, the REPL is just such a pleasurable thing to use."/>
...
<span class="pullquote left" text-content="When we first looked at GraalVM years ago, it didn't really work, and nothing was supported, but now it really does. Oracle have invested a lot, they're selling it now so they need it to work well."/>
...
<span class="pullquote right" text-content="For someone like me, Kondo is brilliant. I despise unordered namespaces, that kinda thing. So having Kondo catch that stuff is great."/>
...
<span class="pullquote left" text-content="[W]e are now building services which are going to be shipped onto machines, written in Clojure, compiled using Graal."/>
...
<span class="pullquote right" text-content="[T]he deps and the tools.build stuff has really fragmented the ecosystem. I don't think anyone cares really. Lein was fine."/>
