...
The ban didn't stop usage; it stopped visibility.
...
Banning AI and mandating it are opposite impulses, but they fail for the same reason: both attempt to control by policy a cost that the technology keeps moving.
...
Try finding someone in Caracas still transacting exclusively in bolívars.
