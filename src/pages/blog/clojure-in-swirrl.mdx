...
clojureIn:
  {
    ...
    quote: '"Clojure is still perceived as new, but there is nothing we have tried to do and found we could not."'
  }
---
...
Lounge](http://www.lambdalounge.org.uk/) and we've picked up a couple of
