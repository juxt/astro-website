...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2016-12-09'
heroImage: 'telenor-logo.jpg'
clojureIn: { season: 'one', industry: 'media & telecommunications', quote: '"The overall effect Clojure has had on me is that I have been rejuvenated."' }
---
