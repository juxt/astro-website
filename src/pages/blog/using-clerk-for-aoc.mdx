...
description: 'Notebooks <3 Clojure'
category: 'clojure'
...
What about having having Day 5 with an interactive step-through slider of the boxes moving? Or Day 11 with monkeys throwing the items around to each other?
