...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2017-07-06'
heroImage: 'health-unlocked-logo.jpg'
clojureIn: { season: 'one', industry: 'healthcare', quote: '"As you write more, you like it more. And it is becoming better and better over time."' }
---
