...
We've got WebAssembly for specific problems. Since we're a canvas app so we're using a bunch of graphical tools too.
...
**Jānis:** Nearly all of Whimsical is a monorepo, including the front-end and back-end infrastructure. We did this to facilitate this reuse of code between front end and back end.
...
**Jānis:** Clojure is very well suited for a company like Whimsical. We want to have a really good place to work, a greate product, and we want to be sustainable for years to come.
