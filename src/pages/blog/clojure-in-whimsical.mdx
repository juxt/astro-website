...
**Jon: Because you're building quite an UI intensive app, it'd be interesting to get your take on ClojureScript.**
...
One of the things I'm looking forward to seeing is what new projects in Clojure are there that will give us alternatives to compiling. There are kind of these pillars that we just accept: compiling using Clojure the compiler; leaning on the Google Closure library. I'll be curious to see how projects continue to evolve away from this because it's just another option.
...
**Jon: It's been great to chat to you. It's a really cool, awesome project. You are exactly what a small/medium sized Clojure team should be doing, punching above it's weight and delivering lots of cool stuff.**
