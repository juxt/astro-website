...
One of the things I'm looking forward to seeing is what new projects in Clojure are there that will give us alternatives to compiling. There are kind of these pillars that we just accept: compiling using Google Clojure Library as the compiler; and leaning on the Google Closure library. I'll be curious to see how projects continue to evolve away from this because it's just another option.
