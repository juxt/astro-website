...
The code-base is about one third back-end and two thirds front-end.
...
**Jānis:** Yeah, for every back-end engineer we have two front end engineers.

Cloud-wise, we run on AWS and we keep things lean and mean. We maintain everything ourselves, everything in containers.
