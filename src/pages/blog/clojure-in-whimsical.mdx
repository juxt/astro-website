---
author: 'joe'
# TODO: Visualisation? Collaboration?
title: 'Clojure in _______: Whimsical'
# TODO:
description: '_______'
category: 'clojure-in'
...
{/* TODO: Expand */}
[Whimsical](https://whimsical.com/) combines whiteboards and docs in an all-in-one collaboration hub.

{/* TODO: Replace with info from intros */}
We chatted with engineers [Jānis Peisenieks](https://www.linkedin.com/in/janispeisenieks/) and [Nate Hunzaker](https://www.linkedin.com/in/nate-hunzaker-5b0095166/) to learn more about what makes Whimsical whimsical.
...
So I'm Jānis. I am the Head of Engineering here at Whimsical. I joined pretty early on, I was employee no.4 I think. Coincidentally, today is my fifth year at Whimsical, so it's been a hell of a ride. Also, just to mention that in terms of Clojure, yes, absolutely. I get it, I read it sometimes, I've written quite a bit, but at the same time, I've been a little bit out of kind of the day to day stuff. I will rely on Nate to comment on the specific; deeply technical questions.
...
**Oliver: Do you find that you Dogfood, do you like use your own tool quite a lot? Because it seems like it would be really valuable for exactly what you're talking about.**
...
**Jon: It seems like it's been successful. You're now five years in and there are a lot of companies using it. Obviously your intuitions about how such a tool should work have proven correct so far.**

**Jānis:** I think that early on in Whimsical's existence many of the engineers and people were talking to said that there was already a hundred different whiteboard tools or a hundred different diagram tools. My response was always there's space for a hundred and one.
...
**Jon: That's critical. You need a technology adoption curve. You need the innovators at the start before you can move on.**
...
**Jānis:** Whimsical is currently around 45 people. Out of those I think it's 17, maybe 18 engineers. In terms of location we start out from Latvia, then Austria, Germany, Denmark and United Kingdom, then we move over to the US. We have some folks on the East Coast like Nate here and then some central US, some folks on West Coast, then three people in New Zealand.

**Nate:** We've really got almost all the time zones.

**Jon: Did you design it like this, did you go for world domination or did it happen naturally?**
...
**Jon: Tell us a bit about the tech. What's the what's the tech make up here of a Whimsical like what does it look like?**

**Jānis:** Whimsical is pretty much a Clojure company as far as the product is concerned. Essentially every place in our product that can be in Clojure almost definitely is in Clojure.
