...
Our first tools were Mind maps and Stickies, then we built our own roadmap management tool. We've since branched out to tools which are less visual and have denser information such as [Whimsical Docs](https://whimsical.com/docs), a multi-user text editing software.
...
**Jānis:** We only split out something as a specific micro-service where it makes sense, be it for scaling characteristics or operational characteristics. Otherwise, we stick to the monolith. In terms of deployments, we deploy between 5 and 50 times a day.
