...
**Nate:** There are times when you want to share ideas and get consensus and work on a board. But on the flip side; working in isolation can be really valuable too, to explore ideas and to think things through.

That's something we've especially had to think about with our docs product. We want to balance the collaboration and the communication when you're working on something together, but also asynchronously, what does it look like to share your ideas, get some feedback and then to iterate from there?
...
**Jānis:** At the start we posted Whimsical Flowchart on Product hunt. There were a couple of product managers from a well known Silicon Valley company who found it and really liked it. Then it spread like wildfire within those companies. Those early users went to new companies and took it with them.
...
I'd say that Clojure really does describe not just the code that we're writing, but also operationally, a lot of the things that we do are really heavily influenced by it.

**Jon: Because you're building quite a UI intensive app, it'd be interesting to get your take on ClojureScript.**

**Jon: Where do you think it's at in terms performance, where you think it might be in terms of integration with React components and the JavaScript ecosystem.**
...
I think it's going to be really interesting to see how ClojureScript as a hosted language continues to evolve over the next couple of years.

One of the things I'm looking forward to seeing is what new projects in Clojure are there that will give us alternatives to compiling. There are kind of these pillars that we just accept: compiling using Clojure the compiler; leaning on the Google Clojure library. I'll be curious to see how projects continue to evolve away from this because it's just another option.
...
**Jon: It's been great to chat to you. It's a really cool, awesome project. It feels nimble and light and the team is productive.**

**Jon: It's exactly what a small/medium sized Clojure team should be doing, punching above it's weight and delivering lots of cool stuff.**
