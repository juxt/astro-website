...
<Image class='not-prose dark:hidden' alt='Exoscale' width={350} height={50} src={exolight} />
<Image class='not-prose hidden dark:block' alt='Exoscale' width={350} height={50} src={exodark} />
