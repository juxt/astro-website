...
import exolight from '../../assets/blog/exoscale-logo-on-light.svg?url'
import exodark from '../../assets/blog/exoscale-logo-on-dark.svg?url'

<img src={exolight} class='not-prose dark:hidden'
  alt='Exoscale'
  width={350}
  height={50} />
<img src={exodark} class='not-prose hidden dark:block'
  alt='Exoscale'
  width={350}
  height={50} />
