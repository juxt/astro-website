...
category: 'clojure-in'
layout: '../../layouts/BlogPostClojureIn.astro'publishedDate: '2017-02-24'
heroImage: 'bandsquare-logo.jpg'
clojureIn: { season: 'one', industry: 'data & analytics', quote: '"We needed a technical shift to change the dynamics."' }
---
