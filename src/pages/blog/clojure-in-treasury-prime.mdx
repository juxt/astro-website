...
_If you're looking to kick-off a project with Clojure and you're interested in some help or advice, don't hesitate to reach out to JUXT. Drop a call into [the calender](https://calendar.google.com/calendar/appointments/schedules/AcZssZ2cJ8bzj8OAv43p7Su3vJ_bjPO4wr_2wJVvXxTL_oPq0xeNPEG_iSYGT8of7HX-ldS3DUAMaWFP) now or reach out via [info@juxt.pro](info@juxt.pro)._