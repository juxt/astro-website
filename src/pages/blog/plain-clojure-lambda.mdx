...
description: 'Write an AWS Lambda with Clojure running on the JVM'
category: 'clojure'
...
tags:
  ...
  - lambda
  - aws
heroImage: 'clojure_plus_lambda.jpg'
---

import { Image } from 'astro:assets'

Recently to help protect our docs and [xt-play](https://play.xtdb.com) against
"the hackernews effect" I converted the backend of `xt-play` to run on AWS
Lambda (previously it was running on AWS ECS with Fargate). While doing so I
had a bunch of trouble so I wanted to write down what worked for me. Hopefully
...
<a target="_blank" href="https://lambda-power-tuning.show/#AAEAAgAEAAYACMAL;AKCARQCA00QA4IxEAMCIRAAAJUQAwGpE;+wORN4NzbjeZ0543jEPnN5kGujfSXEI4">
  <Image alt='As memory increases, invocation time goes down and cost goes up. The graphs meet at roughly 1024MB.' src={cold} />
</a>
...
<a target="_blank" href="https://lambda-power-tuning.show/#AAEAAgAEAAYACMAL;AABAQImIWEBVVWVAAABQQHd3V0C8u1tA;Y3dYMpdPEDOXT5AzY3fYM5dPEDTm9FM0">
  <Image alt='As memory increases, invocation time stays the same and cost goes up.' src={warm} />
</a>
