...
Finally with our jar in hand it's as easy as following [these instructions](https://docs.aws.amazon.com/lambda/latest/dg/java-package.html#java-package-console)
