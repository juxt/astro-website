...
The inverse is playing out in software engineering right now, and almost nobody is using the right language to describe it. The conversation about AI tools is dominated by [Jevons' Paradox](https://en.wikipedia.org/wiki/Jevons_paradox): use a resource more efficiently and total consumption rises. Fine for token costs and compute demand, but it doesn't explain why markets are [convulsing over AI investment](https://techcrunch.com/2025/11/08/is-wall-street-losing-faith-in-ai/) returns, why research into AI coding tools keeps [contradicting itself](https://cmr.berkeley.edu/2025/10/seven-myths-about-ai-and-productivity-what-the-evidence-really-says/) or why engineers who adopt these tools [feel like they're working harder](https://steve-yegge.medium.com/the-ai-vampire-eda6e4f07163) than before.
...
The Seoul highway from the opening suggests not. In 1968, the German mathematician [Dietrich Braess](https://en.wikipedia.org/wiki/Braess%27s_paradox) proved that in a network where agents choose their own routes, adding capacity can make everyone slower. [New York modelled closing 42nd Street](https://en.wikipedia.org/wiki/Braess%27s_paradox#Examples) and predicted the same result; Stuttgart actually closed a road and [journey times fell](https://en.wikipedia.org/wiki/Braess%27s_paradox#Examples). The mechanism is counterintuitive but consistent: local optimisations compound into collective gridlock.
...
In 1983, the cognitive scientist [Lisanne Bainbridge](https://en.wikipedia.org/wiki/Lisanne_Bainbridge) published "[Ironies of Automation](https://www.sciencedirect.com/science/article/abs/pii/0005109883900468)", a short paper on the intractable difficulties that emerge when skilled work meets automated systems.
