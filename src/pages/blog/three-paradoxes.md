...
The current debate about AI and engineering productivity tends to focus on a single altitude at a time, which is part of why the conclusions keep contradicting each other. A CTO who understands the Solow lag but ignores Braess will wonder why faster coding didn't speed up delivery. A team lead who optimises for throughput but ignores Bainbridge will wonder why their best engineers are making worse decisions. An engineer who stays sharp on fundamentals but ignores Solow will wonder why the organisation isn't rewarding their craft.

But Seoul's highway is an optimistic story: the traffic improved because someone understood the system clearly enough to make the counterintuitive call. These three paradoxes offer the same opportunity. Measure the whole delivery network rather than coding speed in isolation. Keep the architecture simple enough that velocity compounds well. Invest deliberately in the human judgement that automation erodes, and hold the quality bar, because speed without rigour is just a bigger mess, sooner.

These principles of simplicity, evidence, judgement and rigour have shaped [how we approach AI-assisted engineering at JUXT](/methodology). If you'd like experienced practitioners to help navigate the transition, [we'd welcome a conversation](mailto:info@juxt.pro?subject=AI-assisted%20engineering).
