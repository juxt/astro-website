...
| -------------------- | ---------------- | ---------- | ------------ | ------------ | ------------ | ------------- | ------------ | --------------- | -------------- | ---------------- | ----------------------------------------------- |
| OpenAI               | ✓                | ✓          |              |              |              | ✓             | ✓            | ✓               |                | ✓                | [Models](https://openai.com/models)             |
| Anthropic            | ✓                | ✓          |              |              |              | ✓             | ✓            | ✓               |                | ✓                | [Models](https://anthropic.com/models)          |
| DeepSeek             | ✓                | ✓          | ✓            | ✓            | ✓            |               | ✓            | ✓               |                |                  | [Models](https://deepseek.com/models)           |
| Meta                 |                  |            | ✓            | ✓            | ✓            |               | ✓            | ✓               |                |                  | [Models](https://meta.ai/models)                |
| Alibaba (Qwen)       | ✓                | ✓          | ✓            | ✓            | ✓            |               | ✓            |                 |                |                  | [Models](https://qwen.alibaba.com/models)       |
| AWS                  |                  |            | ✓            |              |              | ✓             | ✓            | ✓               |                | ✓                | [Models](https://aws.amazon.com/bedrock/models) |
| X (formerly Twitter) |                  |            |              |              |              |               |              |                 |                | ✓                | [Models](https://x.ai/models)                   |
