...
On the other hand, practices for agentic engineering are beginning to catch up. Spec-driven development enters Adopt in Techniques: in our experience, structured specs shape and constrain AI implementations more reliably than ad-hoc prompts. Our view is that formal specification languages provide rigour, whereas informal ones are little better than prompting.
